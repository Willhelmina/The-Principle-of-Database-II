...
--
ALTER TABLE `flproject`
  ADD CONSTRAINT `FL_pro_file` FOREIGN KEY (`project_id`) REFERENCES `profl` (`project_id`),
...
--
ALTER TABLE `fltb`
  ADD CONSTRAINT `fk_file_project_fltb` FOREIGN KEY (`file_id`,`project_id`) REFERENCES `flproject` (`file_id`, `project_id`),
...
--
ALTER TABLE `fltm`
  ADD CONSTRAINT `fk_file_project_fltm` FOREIGN KEY (`file_id`,`project_id`) REFERENCES `flproject` (`file_id`, `project_id`),
